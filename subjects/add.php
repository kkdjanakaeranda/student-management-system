...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $query = "INSERT INTO subjects (subject_code, subject_name, description, class_id, teacher_id) 
                  VALUES (:subject_code, :subject_name, :description, :class_id, :teacher_id)";
        $stmt = $db->prepare($query);
        ...
        <main class="main-content">
            <div class="page-header">
                <div>
                    ...
                    <p>Fill in the subject information below</p>
                </div>

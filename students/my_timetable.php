<?php
// students/my_timetable.php — enrolled classes and their subjects
...
// Enrolled classes with teacher and upcoming exams
...
// Upcoming exams (next 30 days) for enrolled classes
$examStmt = $db->prepare(
    ...
    <main class="main-content">
        ...
        <div class="card" style="margin-bottom:24px;border-left:4px solid #f59e0b;">
            ...
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr><th>Date</th><th>Exam</th><th>Subject</th><th>Class</th><th>Total Marks</th></tr>
                    </thead>
                    <tbody>
        ...
        <?php if (empty($classes)): ?>
            <div class="empty-state">
                ...
                <p>Please contact your administrator to get enrolled.</p>
            </div>
        <?php else: ?>
            ...
            <div class="card" style="margin-bottom:20px;">
                <div class="card-header">
                    ...
                    <div style="font-size:13px;color:var(--color-text-secondary);">
                        ...
                        <?php endif; ?>
                        &nbsp;·&nbsp; Enrolled <?php echo date('M Y', strtotime($cls['enrolled_at'])); ?>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <?php foreach ($subs as $sub): ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $sub['t_first']
                                        ? htmlspecialchars($sub['t_first'] . ' ' . $sub['t_last'])
                                        : '—'; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    ...
                    <?php else: ?>
                        <p style="color:var(--color-text-secondary);">No subjects assigned yet.</p>
                    <?php endif; ?>
                </div>
            </div>
            <?php endforeach; ?>
